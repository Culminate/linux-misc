...
#description     :Show actual submodule branches from git
#author          :Grigoriev Vladislav
#date            :20200613
#version         :0.2
...
#
# Можно показывать пути из .gitmodule или ввести собственные пути
# Добавляем пути в файл .gitracker 
